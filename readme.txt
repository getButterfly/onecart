...
One Cart is a responsive eCommerce WordPress theme.

For more information about OneCart please go to https://getbutterfly.com/downloads/onecart/.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Browse to your OneCart.zip theme package, upload it and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://getbutterfly.com/support/documentation/onecart-documentation/ for a guide on how to customize this theme.
...
* FIX: Fixed readme.txt copyright holder

= 1.9-beta2 =
* FIX: Fixed deprecated (pre-4.3.0) widget registration
* FIX: Moved init functions after theme setup
* FIX: Removed non-functional currency API
* UPDATE: Updated PHP 7 compatibility
* UPDATE: Added readme.txt file and merged changelog
* UPDATE: Updated Twitter SDK
* UPDATE: Updated copyright year and several links
* UPDATE: Tweaked default values

= 1.9-beta =
* FIX: Removed Timthumb
* FIX: Removed references to Open Sans from plugin's Dashboard
* FIX: Script enqueue refactoring
