...
<div id="blog">
	...
	<div class="wrap">
		...
		<div class="blog_title">
			<h1><?php echo get_the_title(get_page_by_path('blog')->ID); ?></h1>
		...
		<ul class="blog_nav">
			...
			?>
				<li<?php if ($cat == $term->term_id) echo ' class="current-cat"'; ?>><a href="<?php echo get_term_link($term->slug, 'category'); ?>"><?php echo $term->name; ?></a></li>
			<?php
				}
			}
			?>
